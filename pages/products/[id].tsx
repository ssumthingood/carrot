...
const ItemDetail: NextPage = () => {
    ...
    const { mutate } = useSWRConfig(); //unboundMutate로 다른 화면에서 설정한 SWR데이터 또한 변경 가능
    console.log(router.query);
    const { data, mutate: boundMutate } = useSWR<ItemDetailResopnse>(router.query.id ? `/api/products/${router.query.id}` : null);
